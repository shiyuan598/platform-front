...
const _1 = require(".");
const BuiltinDeserialize_1 = require("./BuiltinDeserialize");
const builtinSizes = {
...
function buildReader(definitions) {
    ...
    const rootMsg = wrapFn.call(undefined, BuiltinDeserialize_1.deserializers, builtinSizes, typeReaders, _1.StandardTypeReader);
    rootMsg.source = () => wrapFn.toString();
    return rootMsg;
}
exports.default = buildReader;
//# sourceMappingURL=buildReader.js.map