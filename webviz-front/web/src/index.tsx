...
import {
  EventRecorderPage
} from "@foxglove/studio-base/page/EventRecorder";
...
async function main() {
  ...
  if(location.hash=="#recorder"||isMobile()){
    document.title="Zhito Recorder"
    ReactDOM.render(<EventRecorderPage />,
      rootEl,
      renderCallback,
    );
  }else{
    const { Root } = await import("./Root");
    document.title="Zhito Webviz"
    ReactDOM.render(
      <>
        <Root />
      </>,
