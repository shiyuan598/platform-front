  ...
  return (
    ...
    >
      ...
      <TextContent>
        <h1>Welcome</h1>
        <p>
          Zhito Webvis is an integrated visualization and debugging tool for robotics. It allows
        ...
        <p>
          ...
          Zhito Webvis, or just drag &amp; drop it into the app. Click{" "}
        ...
        <Stack tokens={{ childrenGap: theme.spacing.m }}>
          ...
          />
          <Checkbox
            label="Send me updates about Zhito Webvis"
