...
import { Point, OccupancyGridMessage } from "@foxglove/studio-base/types/Messages";
...
export default class GridBuilder implements MarkerProvider {
  ...
  static BuildGrid(settings: GridSettings): OccupancyGridMessage {
    ...
    const grid = {
      ...
      // points: gridPoints,
      // scaleInvariant: true,
    } as unknown as OccupancyGridMessage;
    return grid;
  }
}
