...
(global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.ChartZoom = factory(global.Chart, global.Chart.helpers));
...
function doPan(chartInstance, deltaX, deltaY, panningScales) {
  ...
  if (panOptions.enabled) {
    ...
    helpers.each(panningScales || chartInstance.scales, function(scale) {
